...
const Completed = ({ data, handleLoadMore }: any) => {
    return (
        <View>
            {data && data?.length > 0 ? (
                <>
                        ...
                        renderItem={({ item }) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Text size={13}>총 <Text size={13} color="#ec524f">{item?.userTeeth?.length}</Text>개</Text>
                                </View>
                ...
                <View style={{
                    ...
                    <Text size={13} color="#999">완료된 진료내역이 없습니다.</Text>
                </View>
            )}
